...
//         const postRes = await API.get("/users/my-posts");
...
//       refreshUser?.(); // optional, refresh Auth context
//     } catch (err) {
...
//           src={
//             avatarUrl ||
//             `https://ui-avatars.com/api/?name=${username || user.username}&background=random&color=fff&size=128`
//           }
//           alt={username}
